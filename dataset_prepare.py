...
for outer_name in outer_names:
    ...
    # loop through inner names (emotions)
    for inner_name in gv.emotion_names:
...
df = pd.read_csv(gv.dataset_path, names=['emotion', 'pixels', 'label'])
